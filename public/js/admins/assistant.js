        ...
        "columns": [
            ...
            { "data": "createdBy.name"},
            {
                ...
                "render": function(data,type,row) {
                    if(data['active'] === true) {
                        return '<span class="badge badge-success mr-2 dropdown-toggle" id="dropdownmenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Active</span>'+
                        '<div class="dropdown-menu" aria-labelledby="dropdownmune"><span class="disablebtn dropdown-item">Disable</span></div>';
                    } else {
                        return '<span class="badge badge-warning mr-2 dropdown-toggle" id="dropdownmenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Disable</span>'+
